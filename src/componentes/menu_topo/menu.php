...
<nav class="navbar navbar-expand bg-light">
  <div class="container-fluid">
    <div data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
      <img src="img/logo_h.png" style="height:40px; margin-right:20px;" alt="Sistema de Gestão QrAtivos">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <?=$_SESSION['ProjectRestaurantesLogin']->nome?> <i class="fa-solid fa-user"></i>
                </a>
